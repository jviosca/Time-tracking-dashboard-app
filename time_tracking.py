...
def pie_chart(df):
	...
	plt.pie(df.values, colors=colors, labels=df.index.tolist(), autopct=lambda t: datetime.fromtimestamp(df.values/1000.0).strftime("%H:%M:%S"), pctdistance=0.85, explode=explode) 
